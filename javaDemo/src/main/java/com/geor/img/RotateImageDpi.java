...
public class RotateImageDpi {
	...
	static int xDensity ,yDensity = 200 ;
...
//        JPEGImageEncoder jpegEncoder = JPEGCodec.createJPEGEncoder(g2.geto);
//        JPEGEncodeParam jpegEncodeParam = jpegEncoder.getDefaultJPEGEncodeParam(res);
//        jpegEncodeParam.setDensityUnit(JPEGEncodeParam.DENSITY_UNIT_DOTS_INCH);
//        jpegEncoder.setJPEGEncodeParam(jpegEncodeParam);
//        jpegEncodeParam.setQuality(0.75f, false);
//        jpegEncodeParam.setXDensity(xDensity);
//        jpegEncodeParam.setYDensity(yDensity);
//        jpegEncoder.encode(res, jpegEncodeParam);
...
//        //顺时针旋转270度
        BufferedImage des0 = RotateImageDpi.Rotate(src0, 90);
        File file = new File("c:/90.jpg");
        ImageIO.write(des0, "jpg", file);
...
//        ImageIO.write(des2, "jpg", new File("c:/90.jpg"));
	...
	public static void setDpi(File file ,int xDensity, int yDensity) throws Exception{
